...
def main():
    ...
    #path = "/Documents/data and AI/chozhan_work_dir/KM_And_Search/.config"
    path = os.path.expanduser("~/Documents/data and AI/chozhan_work_dir/KM_And_Search/.config")  # Update this to the correct file path
