...
try {
    Log-Message "Creating Python virtual environment at '$repoDir\myprojectenv'"
    python -m venv "$repoDir\myprojectenv"
    Log-Message "Python virtual environment created successfully."
} catch {
    Log-Message "Error creating virtual environment: $_"
}
...
try {
    ...
    if (Test-Path $vscodePath) {
        ...
        # Install VS Code extensions: Python and Prompt Flow
        Log-Message "Installing VS Code extensions: Python and Prompt Flow"
        try {
            # Install Prompt Flow Extension
            Start-Process -FilePath "C:\Program Files\Microsoft VS Code\Code.exe" -ArgumentList "extension install ms-python.python" -Wait

            # Install Python Extension
            Start-Process -FilePath "C:\Program Files\Microsoft VS Code\Code.exe" -ArgumentList "extension install ms-toolsai.prompt-flow" -Wait

            Log-Message "VS Code extensions installed successfully."
        } catch {
            Log-Message "Error installing VS Code extensions: $_"
        }
    } else {
